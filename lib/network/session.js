...
class ClientSession extends Session {
  ...
  static async connect (address) {
    ...
    // TODO: Use p-timeout to cancel
    /*const cancelablePromise = new PCancelable(async (resolve, reject, onCancel) => {
      // await delay(MAX_TIMEOUT_MILLIS);
      socket.destroy();
      reject(new Error('Failed to connect. Connection timed out.'));
    });*/
